    ...
    <section id="signup" class="main">
        ...
        <div class="get-join-list">
            <table>
                ...
                %>
                <tr>
                    <th><%= item.getUser_id() %></th>
                    <th><%= item.getUser_pw() %></th>
                    <th><%= item.getUser_name() %></th>
                    <th><%= item.getUser_email() %></th>
                    <th><%= item.getUser_hp() %></th>
                    <th><%= item.getUser_addr() %></th>
                    <th><%= item.getUser_gender() %></th>
                    <th><%= item.getUser_birth() %></th>
                    <th><%= item.getGaib_date() %></th>
                </tr>
                <%
                    }
                %>
