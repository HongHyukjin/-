...
public class J03_예외처리두번째 {
  public static void main(String[] args) {
    ...
    try{
    ...
    catch(ArithmeticException e){ // 정수를 0으로 나눌 수 없다는 에러 메시지
      System.err.println("ArithmeticException 정수를 0으로 나눌 수 없습니다.");
      e.printStackTrace();  // 에러 발생위치를 출력
      // e.toString();    // 간단한 문장 출력
    }
      ...
      System.out.println("finally 여기는 예외와 관계없이 실행하고자 하는 것을 실행합니다.");
    }
