...
export default function TopModalComponent() {
    const [state, setState] = React.useState({
        isTopModalClose : false
    })

    const onClickTopmodalClose = (e) => {
        setState({
            ...state,
            isTopModalClose : true
        })
    }
