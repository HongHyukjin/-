...
public class UserDAO {
  ...
  public int update(UserDTO userDTO){
    try{
      String SQL = "UPDATE kurly_table SET user_pw=?,user_name=?,user_email=?,user_hp=?,user_addr=?,user_gender=?,user_birth=?,user_chooga=?,user_service_all=?,user_service_1=?,user_service_2=?,user_service_3=?,user_service_4=?,user_service_5=?,user_service_6=?,user_service_7=? WHERE user_id=?";
      ps = conn.prepareStatement(SQL);
      ...
      ps.setString(9, userDTO.getUser_service_all());
      ps.setString(10, userDTO.getUser_service_1());
      ps.setString(11, userDTO.getUser_service_2());
      ps.setString(12, userDTO.getUser_service_3());
      ps.setString(13, userDTO.getUser_service_4());
      ps.setString(14, userDTO.getUser_service_5());
      ps.setString(15, userDTO.getUser_service_6());
      ps.setString(16, userDTO.getUser_service_7());
      ps.setString(17, userDTO.getUser_id());
      return ps.executeUpdate();
    } 
    catch(Exception e){
      e.printStackTrace();
