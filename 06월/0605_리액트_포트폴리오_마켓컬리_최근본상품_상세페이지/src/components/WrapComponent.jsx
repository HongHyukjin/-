                ...
                <BrowserRouter basename={process.env.PUBLIC_URL}>
                    <Routes>
                        <Route path='/' element={<HeaderComponent setIsIntroFn={setIsIntroFn} mapText={state.mapText} isMap={state.isMap} />}>                            
                            <Route index element={<IntroMainComponent setViewProduct={setViewProduct}  key={key}  />} />
                            <Route path='/main'    element={<IntroMainComponent setViewProduct={setViewProduct}  key={key} />} />
