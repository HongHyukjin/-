                                        ...
                                        <div>
                                                ...
                                                <div className="center-box birth">
                                                    <div className="birth-box">
                                                        <ul>
                                                            <li><input onChange={onChangeUserBirthYear} type="text" maxLength={4} name='user_birth_year' id='userBirthYear' placeholder='YYYY' value={state.연도}/></li>
                                                            <li><i>/</i></li>
                                                            <li><input onChange={onChangeUserBirthMonth} type="text" maxLength={2} name='user_birth_month' id='userBirthMonth>' placeholder='MM' value={state.월}/></li>
                                                            <li><i>/</i></li>
                                                            <li><input onChange={onChangeUserBirthDay} type="text" maxLength={2} name='user_birth_date' id='userBirthDate' placeholder='DD' value={state.일}/></li>
                                                        </ul>
                                                    </div>
                                                </div>                                            
                                            </div>
