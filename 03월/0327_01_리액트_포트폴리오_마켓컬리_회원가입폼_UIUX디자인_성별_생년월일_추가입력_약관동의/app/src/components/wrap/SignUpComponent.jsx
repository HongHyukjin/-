...
export default function SignUpComponent({회원가입, timer, timerCounterFn, mapAddressFn}) {
    ...
    const onClickChoogaIdOkBtn = (e) => {
        ...
        .then((res) =>{     //success
            ...
            isConfirmModal = true;
            if(result.includes(true)){
                confirmMsg = '존재하는 아이디입니다. 친구초대 이벤트에 참여 가능해요.';
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <div>
                                                ...
                                                <div className="chooga-box">
                                                    {
                                                        state.isChooga1 && (
                                                            <>
                                                                <input onChange={onChangeUserChoogaId} type="text" name='user_chooga_id' id='userChoogaId' placeholder='추천인 아이디를 입력해 주세요.' value={state.추천인아이디}/>
                                                    ...
                                                    }
                                                    {
                                                        state.isChooga2 && (
                                                            <>
                                                                <input onChange={onChangeUserChoogaEvent} type="text" name='user_chooga_event' id='userChoogaEvent' placeholder='참여 이벤트명을 입력해 주세요.' value={state.참여이벤트명}/>
                                                                <h6>
                                                ...
                                                {
                                                    state.isChooga1 && (
                                                        <button onClick={onClickChoogaIdOkBtn} disabled={state.isChoogaIdDisabled} className={`chooga-idok-btn${state.isChoogaIdDisabled?' on':''}`}>아이디 확인</button>
                                                    )
                                                }
                                            </div>
                                        </li>
