                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <div>
                                                ...
                                                <div className="center-box">
                                                    <button onClick={onClickOpenAddressApi} className={`addr-search-btn ${state.isAddress?' on':''}`} type='button'>주소검색</button>
                                                    <input className={`${state.isAddress?'on':''}`} type='text' name='user_address1' id='userAddress1' placeholder='검색   주소1' value={주소1}/>
                                                    <input className={`${state.isAddress?'on':''}`} type='text' name='user_address2' id='userAddress2' placeholder='나머지 주소2' value={주소2}/>
                                                    <h5>샛별배송</h5>
                                                    <h6>배송지에 따라 상품 정보가 달라질 수 있습니다.</h6>
                                                </div>
                                                <button className={`addr-research-btn ${state.isAddress?' on':''}`} type='button'>재검색</button>
                                            </div>
                                        </li>                                 
                                        <li>
                                            <div>
