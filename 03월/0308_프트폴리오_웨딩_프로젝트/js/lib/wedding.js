    ...
    section2(){
      ...
      $(window).scroll(function(){
        ...
        if($(window).scrollTop() === 0){
          $('#section2 .content-image, #section2 .content-text, #section2 .icon-box').removeClass('on');
        }


        if($(window).scrollTop() >= sec1Top){
          $('#section2 .content-image, #section2 .content-text, #section2 .icon-box').addClass('on');
        }
      });
    },
    section3(){
