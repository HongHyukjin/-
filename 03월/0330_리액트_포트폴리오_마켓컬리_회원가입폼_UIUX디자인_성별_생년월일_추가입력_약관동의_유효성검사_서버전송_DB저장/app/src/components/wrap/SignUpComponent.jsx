...
export default function SignUpComponent({회원가입, timer, timerCounterFn, mapAddressFn}) {
    ...
    const onSubmitSignupEvent = (e) => {
        ...
        //AXIOS({}).then().catch()
        // $.ajax({
        //     url:'http://gurwlszx.dothome.co.kr/signup_db/insert.php',
        //     type:'POST',
        //     data : {
        //         아이디 : 'hyukjin',
        //         이름 : '홍혁진'
        ...
        if(state.아이디 === ''){
            ...
            setState({
                ...state,
                isConfirmModal : true,
                confirmMsg : '이용약관동의 필수 항목 3개를 선택해야합니다.'
            })
        }
            ...
            // 중간 숫자 3~4자리 (그룹2) $2
            // 끝 숫자 4자리     (그룹3) $3
            const regExpHp = /^(\d{3})(\d{3,4})(\d{4})$/g;   //010-9662-9052 
                                        ...
                                        <li>
                                            <div>
                                                ...
                                                <div className="center-box">
                                                    ...
                                                    <input onFocus={onChangeAddr1} className={`${state.isAddress?'on':''}`} type='text' name='user_address1' id='userAddress1' placeholder='검색   주소1' value={state.주소1}/>
                                                    <input onFocus={onChangeAddr2} className={`${state.isAddress?'on':''}`} type='text' name='user_address2' id='userAddress2' placeholder='나머지 주소2' value={state.주소2}/>
                                                    <h5>샛별배송</h5>
