  ...
  const wedding = {
    ...
    section1(){
      ...
      function mainNextSlide(){
        ...
        $slide.eq(temp!==null?temp:cnt(cnt===0?2:cnt-1)).css({zIndex:2})
      ...
      function mainPrevSlide(){
        ...
        $slide.eq(temp!==null?temp:cnt(cnt===2?0:cnt+1)).css({zIndex:3}).stop().animate({opacity:1},0).stop().animate({opacity:0},1000);
        pageBtn();
      }
